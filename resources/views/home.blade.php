            ...
            @foreach($movies as $movie)
                ...
                <div class="home__card">
                    <a href="{{route('detail', ['id' => $movie->id]) }}">
                        <img src="{{ asset('storage/cover_images/' . $movie->cover_image) }}" alt="{{ $movie->title }}" style="width: 414px; height: 330px;">
                    </a>
                    <div>
                        <h2>{{ $movie->title }}</h2>
                        <ul>
                        ...
                        @forelse ($movies as $movie)
                            ...
                            <div class="col-12 col-md-6 col-xl-4">
                                <div class="card card--big">
                                    <a href="{{route('detail', ['id' => $movie->id]) }}" class="card__cover">
                                        <img src="{{ asset('storage/cover_images/' . $movie->cover_image) }}" alt="{{ $movie->title }}" style="width: 192px; height: 270px;">
