...
<body>
	...
	<!-- head -->
	<section class="section section--head" style="margin-top: 0px; border-top: 2px solid #151f30;">
		<div class="container">
			<div class="row">
				...
				<div class="col-12">
					<div class="profile">
						...
						<ul class="nav nav-tabs profile__tabs" id="profile__tabs" role="tablist">
							<li class="nav-item">
								<a class="nav-link active" data-toggle="tab" href="#tab-1" role="tab" aria-controls="tab-1" aria-selected="true">Settings</a>
							</li>
							...
							<div class="sign__wrap">
								<div class="row">
									...
									<div class="col-12 col-lg-6">
										<form action="{{ route('user-profile-information.update') }}" class="sign__form sign__form--profile sign__form--first" method="POST">
											@csrf
                                            @method('PUT')
											<div class="row">
												<div class="col-12">
												...
												<div class="row">
													<div class="col-12">
														<label class="sign__label" for="username">Profile</label>
														<div class="form__gallery">
															<label id="gallery1" for="form__gallery-upload">Upload Profile</label>
												...
												<div class="row">
													<div class="col-12 col-md-6 col-lg-12 col-xl-6">
														<div class="sign__group">
															<label class="sign__label" for="name">Username</label>
															<input id="name" type="text" name="name" class="sign__input" value="{{ old('name', $users->name)}}">
														</div>
													</div>
													...
													<div class="col-12 col-md-6 col-lg-12 col-xl-6">
														<div class="sign__group">
															...
															<input id="email" type="text" name="email" class="sign__input" value="{{ old('email', $users->email)}}">
														</div>
													</div>
												</div>
												<div class="col-12">
													<button class="sign__btn" type="sumbit">Update</button>
												</div>
											</div>
										</form>
									</div>
									...
									<!-- password form -->
									<div class="col-12 col-lg-6">
										<form action="{{ route('user-password.update') }} " class="sign__form sign__form--profile" method="POST">
											@csrf
											@method('PUT')
											<div class="row">
												<div class="col-12">
												...
												<div class="col-12 col-md-6 col-lg-12 col-xl-6">
													@if (session('status') === 'password-update')
														<div class="alert alert-success">Your password has been update</div>
													@endif
													<div class="sign__group">
												...
												<div class="col-12">
													<button class="sign__btn" type="sumbit">Change</button>
												</div>
											</div>
										</form>
									</div>
												...
												<div class="row">
													<div class="col-12 col-md-6 col-lg-12 col-xl-6">
														<div class="row">
															<div class="col-12 col-md-6 col-lg-12 col-xl-6">
																<div class="sign__group">
																	<label class="sign__label" for="username">Upload Profile</label>
																	<input id="username" name="form__img-upload" class="sign__input" type="file" accept=".png, .jpg, .jpeg" style="
																	align-content: center;">
																</div>
															</div>
															{{-- <div class="col-12 col-sm-6 col-md-12">
																<div class="sign__group form__img">
																	<label for="form__img-upload">Upload Profile (190 x 270)</label>
												...
												<div class="row">
													<div class="col-12 col-md-6 col-lg-12 col-xl-6">
														<div class="sign__group">
															...
															<input id="username" type="text" name="username" class="sign__input" placeholder="{{ Auth::user()->name}}">
														</div>
													</div>
													...
													<div class="col-12 col-md-6 col-lg-12 col-xl-6">
														<div class="sign__group">
															<label class="sign__label" for="email">Email</label>
															<input id="email" type="text" name="email" class="sign__input" placeholder="{{ Auth::user()->email}}">
														</div>
													</div>
												</div>
												<div class="col-12">
