						...
						<div class="series-wrap">
							...
							<div class="section__carousel-wrap">
								<div class="section__series owl-carousel" id="series">
									...
									<div class="series">
										<a href="{{route('detail', ['id' => $movie->id]) }}" class="series__cover">
											<img src="{{ asset('storage/cover_images/' . $movie->cover_image) }}" alt="{{ asset('storage/cover_images/' . $movie->cover_image) }}" style="width: 414px; height: 160px">
											<span>
